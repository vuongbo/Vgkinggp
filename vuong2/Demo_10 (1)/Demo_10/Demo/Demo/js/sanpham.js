...
$(document).ready(function() {
    $("#locbanhkem").click(function(e) {
        ...
        const filtered = productList.filter(product => {
            ...
            if (product.category !== "banhkem") return false;
        ...
        // Hiển thị sản phẩm đã lọc
        displayProducts(filtered, "banhkem");
...
$(document).ready(function() {
    $("#locbanhngot").click(function(e) {
        ...
        const filtered = productList.filter(product => {
            // Chỉ lọc sản phẩm trong danh mục bánh kem
            if (product.category !== "banhngot") return false;
...
$(document).ready(function() {
    $("#locbanhquy").click(function(e) {
        ...
        // Hiển thị sản phẩm đã lọc
        displayProducts(filtered, "banhquy");
...
$(document).ready(function() {
    $("#locsocola").click(function(e) {
        ...
        const filtered = productList.filter(product => {
            // Chỉ lọc sản phẩm trong danh mục bánh kem
            if (product.category !== "socola") return false;
        ...
        // Hiển thị sản phẩm đã lọc
        displayProducts(filtered, "socola");
...
$(document).ready(function() {
    $("#lockem").click(function(e) {
        ...
        const filtered = productList.filter(product => {
            // Chỉ lọc sản phẩm trong danh mục bánh kem
            if (product.category !== "kem") return false;
